...
date: "2023-03-27"
description: 本文记录 Next.js + Strapi CMS + Ubuntu 搭建内容管理系统的过程，Strapi CMS 是一个开源的内容管理系统，使用 Node.js 和 MongoDB 构建，支持 RESTful API 和 GraphQL API。
published: true
tags: ["Next.js", "Strapi CMS", "Ubuntu", "PM2", "Nginx", "ZeroSSL"]
---
