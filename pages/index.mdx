...
<div className={'lg:grid lg:grid-cols-2 z-10'}>
    <div className={'w-full h-max py-12 mt-28'}>
        ...
        <div className={'flex h-max text-3xl lg:text-6xl font-bold w-full justify-start items-center lg:-mt-3'}>
            <div>I'm&nbsp;</div>
 <div className={'linear-gradient-text leading-loose'}>Orange&nbsp;</div>
 <div>Cheng.</div>
        </div>
        <div className={'text-xl lg:text-4xl font-bold text-gray-600 dark:text-gray-300 -mt-2'}>
            A fanatical <b className={'underline decoration-wavy underline-offset-2 decoration-blue-500'}>front-end</b> learner.
        </div>
