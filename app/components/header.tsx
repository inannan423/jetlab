...
export const Header: React.FC<Props> = ({ title, description, views, repository, url, backLink, date }) => {
                ...
                <div className="container mx-auto relative isolate py-24 sm:py-32"> {/* Keep isolate and z-40 here */}
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center flex flex-col items-center z-50">
                        <div className="mx-auto max-w-2xl lg:mx-0 z-40">
                            <h1 ref={titleRef} className="text-4xl tracking-wide font-bold text-black sm:text-5xl font-display">
                                {title}
                            </h1>
                        ...
                        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none z-40">
